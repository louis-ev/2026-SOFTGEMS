...
export const selection_pdf_strings = Object.freeze({
  en: Object.freeze({
    ...
    legal_memo_out:
      "It is expressly agreed that the goods are delivered on a deposit (consignment) basis and do not constitute a sale. Under no circumstances may the depositary dispose of the possession or control of the goods, in particular for the benefit of a third party, and the depositary must at all times be able to present and return them upon first request. The goods are delivered and entrusted to the depositary for the purpose of either presenting them to customers or carrying out work or transformation operations concerning them. The deposit shall end only upon the effective return of the goods. Failure to return the goods shall constitute the criminal offence of breach of trust. The depositary undertakes to insure said goods, for the account of the depositor, against all risks of loss or damage, for their total value including all taxes. Receipt of the goods constitutes irrevocable acceptance of these stipulations and conditions.",
    legal_generic:
