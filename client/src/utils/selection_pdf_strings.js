...
export const selection_pdf_strings = Object.freeze({
  en: Object.freeze({
    ...
    payment_line:
      "Please kindly transfer {amount_words} {currency_name}{cents_clause} ({amount} {currency_code_display}).",
    ...
    reference_customer_prefix: "Reference customer: {value}",
  ...
  fr: Object.freeze({
    ...
    payment_line:
      "Merci de bien vouloir virer {amount_words} {currency_name}{cents_clause} ({amount} {currency_code_display}).",
    ...
    reference_customer_prefix: "Référence client : {value}",
