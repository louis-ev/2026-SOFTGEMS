export default {
  ...
  sg_pdf_export_bank_footer_hint:
    "Shown under the table in the exported PDF. The first footer is selected by default when exporting.",
  ...
  sg_pdf_title_buying_invoice: "Facture d’achat N° {number}",
  sg_pdf_title_sale_invoice: "Facture de vente N° {number}",
  sg_pdf_title_partner_invoice: "Facture partenaire N° {number}",
  sg_pdf_title_credit_note: "Avoir N° {number}",
