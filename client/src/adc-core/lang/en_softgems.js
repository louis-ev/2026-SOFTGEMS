export default {
  ...
  sg_columns_modal_instructions:
    "Enable or disable columns, then drag rows to reorder them. Pricing columns (Cost, PA, PV, …) and dimensions are single columns in the table: each shows total + per carat (/ct) or L × W × H together.",
