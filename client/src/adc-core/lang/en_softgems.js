export default {
  ...
  sg_gems_search_placeholder:
    "Search: numeric ID; weight: 3. or 3, → all 3.x ct; 3.1 → 3.0–3.2 ct; =2 exact ct; ± / +/- range; sap / rub; text matches stone type",
  sg_gems_filter_caption: "Filtered: {clauses} · {shown} of {total} gems",
  sg_gems_filter_id_starts_with: "ID starts with “{needle}”",
  ...
  sg_gems_filter_stone_text: 'Stone contains “{needle}” — {matches}',
