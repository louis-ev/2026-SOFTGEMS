export default {
  ...
  sg_gems_column_filter_empty: "No value",
  ...
  sg_gems_table_totals_all_gems:
    "Totals below are for all {total} gems, not only this page.",
  ...
  sg_duplicate_gem: "Duplicate gem",
  sg_duplicate_gem_modal_title: "Duplicate gem",
  sg_duplicate_gem_modal_intro:
    'Create a new gem from "{name}". A new ID is assigned. Most fields, cover, photos, videos and certificates are copied.',
  sg_duplicate_gem_changes_title: "Meta that will change on the copy",
  sg_duplicate_gem_kept_title: "What stays the same",
  sg_duplicate_gem_kept_fields:
    "Stone fields (type, weight, colour, prices, references, etc.)",
  sg_duplicate_gem_kept_media: "Cover image, photos, videos and certificates",
  sg_duplicate_gem_new_id_value: "New sequential ID",
  sg_duplicate_gem_empty_value: "-",
  sg_duplicate_gem_cleared_value: "Cleared",
  sg_duplicate_gem_field_box: "Box",
  sg_duplicate_gem_field_selections: "Selection memberships",
  sg_duplicate_gem_field_history: "Modifications history",
  sg_duplicate_gem_history_from: "Source gem history",
  sg_duplicate_gem_history_to: "Fresh history on the copy",
  sg_duplicate_gem_confirm: "Duplicate",
  sg_duplicate_gem_in_progress: "Duplicating...",
  ...
  sg_gems_table_col_origin: "Origin",
  sg_gems_table_col_coc: "COC",
  sg_gems_table_col_treatment: "Treatment",
  sg_gems_table_col_dimensions_lwh: "L×W×H (mm)",
  sg_gems_table_col_edited: "Edited",
  sg_gems_table_col_paired_gem: "Pair",
  ...
  sg_gems_table_total_row_count: "Total",
  sg_gems_table_rse_total_row: "RSE",
  sg_gems_table_pf_total_row: "PF",
  ...
  sg_pdf_export_modal_instructions:
    "Language, price line, VAT, customs summary and bank footer are set here — currency, header fields and notes come from the selection.",
  ...
  sg_pdf_export_bank_footer_hint:
    "Shared by all users. Shown under the table when a price line is selected — “No footer” is the default. Only instance admins can create, edit, or remove presets.",
