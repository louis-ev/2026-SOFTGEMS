...
- **PDF language:** chosen at export time (`en` default). Titles, column headers, legal text, payment line, and ACF company footer follow [selection_pdf_strings.js](../client/src/utils/selection_pdf_strings.js).
